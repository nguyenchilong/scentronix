...
const hexColorToRGB = function(hexColor) {
	let detectShorthand = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
	hexColor = hexColor.replace(detectShorthand, function(m, r, g, b) {
		return r + r + g + g + b + b;
	});
	const hex_array = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hexColor);
	return hex_array
		? {
...
const mangeColor = '#3C4858';
const whiteColor = '#ffffff';
const fullBlackColor = '#000000';
const blackColor = 'rgba(0, 0, 0, 0.87)';
